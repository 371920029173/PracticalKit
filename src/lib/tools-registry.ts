...
export const TOOLS: ToolDef[] = [
  ...
  { segment: "dns-lookup", navKey: "dnsLookup", category: "network", mode: "thirdParty", keywords: ["dns", "domain", "a record", "mx"], isNew: true },
  { segment: "mushroom-quiz", navKey: "mushroomQuiz", category: "fun", mode: "local", keywords: ["poison", "mushroom", "quiz"] },
  { segment: "morse", navKey: "morse", category: "fun", mode: "local", keywords: ["morse", "dot dash", "telegraph"], isNew: true },
  { segment: "bmi", navKey: "bmiCalc", category: "daily", mode: "local", keywords: ["bmi", "body mass", "weight"], isNew: true },
  { segment: "percent", navKey: "percentCalc", category: "math", mode: "local", keywords: ["percentage", "percent", "ratio"], isNew: true },
  { segment: "url-parser", navKey: "urlParser", category: "dataDev", mode: "local", keywords: ["url", "parse", "query string", "hostname"], isNew: true },
