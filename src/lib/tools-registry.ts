...
export const TOOLS: ToolDef[] = [
  ...
  { segment: "ip-lookup", navKey: "ipLookup", category: "network", mode: "thirdParty", keywords: ["ip", "geo", "location"], isNew: true },
  { segment: "user-agent", navKey: "userAgent", category: "network", mode: "local", keywords: ["browser", "ua"], isNew: true },
  { segment: "mushroom-quiz", navKey: "mushroomQuiz", category: "fun", mode: "local", keywords: ["poison", "mushroom", "quiz"], isNew: true },
